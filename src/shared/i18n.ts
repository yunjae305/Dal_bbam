...
const ko = {
  ...
  map: {
    ...
    seeOnMap: '지도에서 보기',
    otherModes: '다른 이동수단',
    toggleList: '장소 목록 펼치기·접기',
    listCount: '장소 {count}곳',
    outsideServiceArea: '지금 위치가 경주 밖이라 현재 위치를 출발지로 쓸 수 없어요. 지도를 눌러 경주 안에서 출발지를 골라 주세요.',
    zoomIn: '지도 확대',
    zoomOut: '지도 축소',
    arriveBy: '{time} 도착 예정',
...
export const messages: Record<Lang, MessagesShape> = {
  ...
  en: {
    ...
    map: {
      ...
      otherModes: 'Other ways to get there',
      toggleList: 'Expand or collapse the place list',
      listCount: '{count} places',
      outsideServiceArea: 'You are outside Gyeongju, so your current location cannot be the start. Tap the map to pick a starting point in Gyeongju.',
      zoomIn: 'Zoom in',
      zoomOut: 'Zoom out',
  ...
  ja: {
    ...
    map: {
      ...
      toggleList: '場所リストを開閉',
      listCount: '{count}件',
      outsideServiceArea: '現在地が慶州の外のため出発地に使えません。地図をタップして慶州内の出発地を選んでください。',
      zoomIn: '地図を拡大',
      zoomOut: '地図を縮小',
      arriveBy: '{time} 到着予定',
  ...
  zh: {
    ...
    map: {
      ...
      seeOnMap: '在地图上查看',
      otherModes: '其他出行方式',
      toggleList: '展开或收起地点列表',
      listCount: '{count} 个地点',
      outsideServiceArea: '您当前不在庆州，无法将当前位置设为出发地。请点击地图在庆州范围内选择出发地。',
      zoomIn: '放大地图',
      zoomOut: '缩小地图',
      arriveBy: '预计 {time} 到达',
