...
import { GYEONGJU_SERVICE_BOUNDS, type GeoBounds } from '@/shared/service-area';

export type { GeoBounds, GeoPoint } from '@/shared/service-area';
export { GYEONGJU_CENTER, GYEONGJU_SERVICE_BOUNDS, isInGyeongjuServiceArea } from '@/shared/service-area';
