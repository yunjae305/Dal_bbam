...
describe('short API mapping', () => {
  it('does not claim manually authored content was generated by AI', () => {
    expect(mapShortRow({ id: 'manual' }).isAiGenerated).toBe(false);
    expect(mapShortRow({ id: 'manual', narration_id: null }).isAiGenerated).toBe(false);
  });
