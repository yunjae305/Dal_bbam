...
type HomeCategory = {
  id: 'ai' | 'transport' | 'food' | 'festival' | 'map' | 'shorts' | 'community' | 'stamp';
  icon: string;
  filter?: MapFilter;
  href?: string;
};
...
const homeCategories: HomeCategory[] = [
  ...
  { id: 'stamp', icon: '/assets/home/icons/카테고리-스탬프.png', href: '/stamps' }
];
...
function HomeScreen({
  ...
  const labelForHomeCategory = (id: string) => {
    ...
    if (id === 'stamp') return messages.home.stamps;
    ...
    <section className="min-h-[calc(100dvh-40px)] bg-[#f5f1ea]">
      <div className="relative min-h-[284px] bg-[#2d2a26] text-white">
        ...
        <div className="relative z-10">
          ...
          <div className="px-6 pt-8">
            ...
            <h1 className="mt-1 whitespace-nowrap text-[clamp(15px,4.6vw,20px)] font-black leading-[1.3]">
      ...
      <div className="relative z-20 mx-10 -mt-14 rounded-xl bg-[#eee9df]/95 px-4 py-3 shadow-[0_10px_28px_rgba(0,0,0,.28)]">
        <div className="grid grid-cols-4 gap-y-3">
            {homeCategories.map(({ id, icon, filter, href }) => (
              <button
                key={id}
      ...
      <div className="px-5 pt-6">
        <SectionHeader title={explore.popular} action={`${messages.common.viewAll} >`} onAction={onViewAllPlaces} />
